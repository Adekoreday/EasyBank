...
const account = (state = { ...initialState }, action) => {
  switch (action.type) {
    case GET_ALL_ACCOUNTS_REQUEST:
      return {
        ...state, loading: true, isSuccess: false, allAccount: {}, isfailedAllAccount: {}
      };
    case GET_ALL_ACCOUNTS_FAILURE:
      return {
        ...state, loading: false, isSuccess: false, isfailedAllAccount: action.data
      };
    case GET_ALL_ACCOUNTS_SUCCESS:
      return {
        ...state, loading: false, isSuccess: true, allAccount: action.data
      };
    case CREATE_ACCOUNTS_REQUEST:
      return {
        ...state, createAccountloading: true, isSucessCreateAccount: false, createdAccount: {}, isfailedCreateAccount: {}
      };
    case CREATE_ACCOUNTS_FAILURE:
      return {
        ...state, createAccountloading: false, isfailedCreateAccount: action.data, isSucessCreateAccount: false
      };
    case CREATE_ACCOUNTS_SUCCESS:
      return {
        ...state, createAccountloading: false, isSucessCreateAccount: true, createdAccount: action.data
      };
    ...
    case GET_ALL_USERS_ACCOUNTS_REQUEST:
      return {
        ...state, isallUserAccountLoading: true, isSuccessAllUsersAccount: false, allUsersAccount: [], isfailedAllUsersAccounts: {}
      };
    case GET_ALL_USERS_ACCOUNTS_FAILURE:
      return {
        ...state, isallUserAccountLoading: false, isSuccessAllUsersAccount: false, isfailedAllUsersAccounts: action.data
      };
    case GET_ALL_USERS_ACCOUNTS_SUCCESS:
      return {
        ...state, isallUserAccountLoading: false, isSuccessAllUsersAccount: true, allUsersAccount: action.data
      };
    case ACTIVATE_ACCOUNT_REQUEST:
      return {
        ...state, activateAccountLoading: true, isactivateAccountSucess: false, activateAccount: null, isactivateAccountFailed: null
      };
    case ACTIVATE_ACCOUNT_SUCCESS:
      return {
        ...state, activateAccountLoading: false, isactivateAccountSucess: true, activateAccount: action.data
      };
    case ACTIVATE_ACCOUNT_FAILURE:
      return {
        ...state, activateAccountLoading: false, isactivateAccountSucess: false, isactivateAccountFailed: action.data
      };
    default:
      return state;
  }
